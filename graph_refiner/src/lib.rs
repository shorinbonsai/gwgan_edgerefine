...
impl GraphRefiner {
    ...
    fn load_initial_graph(&mut self, num_nodes: usize, edge_index: Vec<(usize, usize)>, seed: u64) {
    ...
    fn set_operation_weights(&mut self, weights: Vec<f64>) {
    ...
    fn evolve(&mut self, generations: usize, seed: u64) -> f64 {
